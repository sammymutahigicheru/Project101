...
###  Doing coding interview questions while I'M learning data structures and algorithms 

I need to apply what I will be learning to solving problems so that I can't forget.Once I've learned a topic, 
and feel comfortable with it, like linked lists,I will be opening one of the coding interview books and do a couple of questions regarding 
linked lists. Then move on to the next learning topic. Then later, go back and do another linked list problem, 
or recursion problem, or whatever. But i'll keep doing problems while i'm learning. ``I'm not being hired for knowledge, 
but how I apply the knowledge. There are several books and sites recommended``. 
See here for more: [Coding Question Practice](#coding-question-practice). 

## The Daily Plan

Some subjects will take one day, and some will take multiple days. Some are just learning with nothing to implement.

Each day I take a Problem on a topic let's say graph theory, watch videos about that subject, and write an implementation in either:
  -java
  -kotlin
  -python
  -javascript

Why code in all of these yet only one language is required?
...
I don't need to memorize the guts of every algorithm.

Write code on a paper, not a computer. Test with some sample inputs. Then test it out on a computer.
...
- ### Arrays
    ...
    - [x] Implement a dynamic (mutable array with automatic resizing):
        - [x] New raw object data array with allocated memory
...
- ### Linked Lists
    ...
    - [x] Doubly-linked List
        ...
        - No need to implement (Not always asked in interviews)
    - [x] Time
